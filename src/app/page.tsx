...
const perks = [
  ...
  },
  {
    ...
    icon: CheckCircle,
    description: "Every asset is verified by our team. Not happy? Get a refund",
  },
  {
    name: "For the Planet",
    icon: Leaf,
    description: "We're committed to planting 1 tree for every purchase made",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground ">
            Welcome to Next Payload Marketplace. Every asset on our platform is
